...
- (IBAction)stopSynchronousSheet:(id)sender;
...
- (NSInteger)runModalSheetForWindow:(NSWindow *)aWindow
{
    ...
    for (NSButton *button in [self buttons]) {
        ...
        [button setAction:@selector(stopSynchronousSheet:)];
    }
    ...
    // This is called only after stopSynchronousSheet is called (that is, one of the buttons is clicked)
